...
```{r,warning=FALSE,message=FALSE}
DS$Announcement_Types <- factor(DS$Announcement_Types,levels = c("Kaza Bildirimi", "Yoðun Trafik", 
                                                             "Araç Arýzasý", "Haber",
                                                             "Bakým-Onarým Çalýþmasý",
                                                             "Çevre Düzenlemesi", "Araç Yangýný",
                                                             "Yolun Trafiðe Kapanmasý",
                                                             "Þehir Hatlarý Sefer Bildirisi",
                                                             "ÝDO Sefer Bildirisi","Yol Yapým Çalýþmasý",
                                                             "Alt Yapý Çalýþmasý",
                                                             "Yolu Etkileyen Hava Koþulu",
                                                             "Ýmalat Çalýþmasý","Diðer",
...
```{r,warning=FALSE,message=FALSE}
DS$Accident_Types <- factor(DS$Accident_Types,levels = c("trafik kazasý (hasarlý)", "trafik kazasý (yaralanmalý)", 
                                                         "trafik kazasý (zincirleme)", "trafik kazasý (can kaybý)",
                                                         "Seçiniz")) 
...
- [Data Source - ÝBB Open Data Portal](https://data.ibb.gov.tr/dataset/ulasim-yonetim-merkezi-uym-tarafindan-sisteme-girilen-trafik-duyurulari)
